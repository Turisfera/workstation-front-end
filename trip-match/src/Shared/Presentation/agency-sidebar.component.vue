...
const links = [
  ...
  { label: 'sidevar.experienceManager', path: '/agency/manageExperience', icon: 'pi pi-objects-column' },
  { label: 'sidevar.reservations',      path: '/agency/reservations',     icon: 'pi pi-pen-to-square' },
  { label: 'sidevar.queries',           path: '/agency/queries',          icon: 'pi pi-search' },
